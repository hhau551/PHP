                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <ul class="single-footer-links">
                            <li><a action="Index" controller="Home">Trang chủ</a></li>
                            <li><a action="Products" controller="Home">Sản phẩm</a></li>
                            <li><a action="FlashSale" controller="Home">Sale</a></li>
                            <li><a action="Blog" controller="Home">Tin tức</a></li>
                            <li><a action="Contact" controller="Home">Liên hệ</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3  col-md-6 col-sm-6">
