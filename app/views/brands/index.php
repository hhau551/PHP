...
<div class="color-dashboard">
    <h2 class="main-title text-center pt-4">DANH SÁCH THƯƠNG HIỆU</h2>
    <div class="col-lg-12 m-auto px-5">
    <a href="?route=index" class="btn btn-outline-dark" role="button">Quay lại</a>
            ...
            <table class="posts-table mt-3">
                <thead>
                    <tr class="users-table-info">
                        ...
                        <th class="dashboard-txt">
                            <a>
                                <span style="font-weight:bold;">Name</span><i class="fas fa-sort ml-2"></i>
                            </a>

                        </th>
                        <th class="dashboard-icon pb-3">
                            <a href="?route=brand" class="btn btn-primary">
                ...
                <tbody>
                    <?php foreach ($danhSachBrand as $brand): ?>                    
                        <tr>
                            ...
                            <td>
                                <a href="?route=edit-brand&brandid=<?= $brand['BrandID']?>" class="btn-edit-color"><i class="far fa-edit dashbroad-icon-hover" style="font-size: 1.5rem;"></i></a>
                                <a href="?route=delete-brand&brandid=<?= $brand['BrandID']?>" ><i class="far fa-trash-alt ml-3 dashbroad-icon-hover" style="font-size: 1.5rem;"></i></a>
                                <input type="hidden" class="id" value="@item.BrandID" />
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
