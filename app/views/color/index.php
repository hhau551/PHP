...
<div class="color-dashboard">
    <h2 class="main-title text-center pt-4">DANH SÁCH MÀU</h2>
                ...
                <thead>
                    <tr class="users-table-info">
                        ...
                        <th class="dashboard-icon pb-3">
                            <a href="?route=color" class="btn btn-primary">
                ...
                <?php foreach ($danhSachColor as $color): ?>
                    <tr>
                        ...
                        <?= $color['Color'] ?>
                            ...
                            <td>
                                <a href="?route=edit-color&colorid=<?= $color['ColorID']?>" class="btn-edit-color"><i class="far fa-edit dashbroad-icon-hover" style="font-size: 1.5rem;"></i></a>
                                <a href="?route=delete-color&colorid=<?= $color['ColorID']?>" ><i class="far fa-trash-alt ml-3 dashbroad-icon-hover" style="font-size: 1.5rem;"></i></a>
