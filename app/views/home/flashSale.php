        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
            ...
            <div class="filter-bar d-flex flex-wrap align-items-center">
                <div class="sorting custom-sort-product">
                    <a href="@Url.ActionLink("FlashSale", "Home", new { sortOrder = ViewBag.PriceSortParm })">
                        <span>Giá từ: </span>
                                    ...
                                    <div class="single-product">
                                        <a asp-action="Details" asp-route-id="@item.ProductID">
                                            <div class="img-prd-animation">
                                                <div class="img-fluid">
                                                    <img class="" src="~/images/Product/@item.Image" alt="">
                                                    @if (item.Sale > 0)
                                                    {
                                        ...
                                        <div class="product-details mt-3">
                                            <h6 class="custom-title-product">
                                                <a class="text-decoration-none text-link-hover" data-toggle="tooltip"
                                                   title="@item.ProductName" asp-action="Details" asp-route-id="@item.ProductID">
                                            ...
                                            <div class="prd-bottom">
                                                ...
                                                else
                                                {
                                                    <a class="addProduct social-info" disabled="disabled">
                                                        <span class='bx bx-basket  custom-history-trash-disable'></span>
                                                        <p class="hover-text">Giỏ hàng</p>
                                                    </a>
                                                }
