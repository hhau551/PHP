                        ...
                        <div class="">
                            ...
                            <div class="slide active col-lg-12">
                                ...
                                <div class="img top-down col-lg-6">
                                    ...
                                    <img src="../root/images/banner/banner-img.png" alt="">
                                </div>
                            </div>
                            <!-- end slide item -->
                            <!-- slide item -->
                            <div class="slide col-lg-12">
                                <div class="info col-lg-6">
                                    <div class="info-content">
                                        ...
                                        <p class="top-down trans-delay-0-4">
                                            Nike Air Force 1 đã trở thành một hiện tượng vô cùng hot với thiết kế có một không hai, một đôi giày nhưng ẩn chứa là một đôi giày khác.
                                        </p>
                                        <div class="top-down trans-delay-0-6 d-flex align-items-center">
                                            <a href="#" class="btn-icon"> <i class='bx bx-expand-alt bx-sm'></i></a>
                                            <span class="btn-flat btn-hover">
                                ...
                                <div class="img right-left col-lg-6">
                                    <div class="img-shape"></div>
                                    <img src="../root/images/banner/airforceone.png" alt="">
                                </div>
                            </div>
                            <!-- end slide item -->
                            <!-- slide item -->
                            <div class="slide col-lg-12">
                                <div class="info col-lg-6">
                                    <div class="info-content">
                                        ...
                                        <p class="top-down trans-delay-0-4">
                                            Vans Old Skool Green mang màu sắc chủ đạo sáng mắt, VANS vẫn giữ những giá trị vốn có mà OLD SKOOL đã khẳng định.
                                        </p>
                                        <div class="top-down trans-delay-0-6 d-flex align-items-center">
                                            <a href="#" class="btn-icon"> <i class='bx bx-expand-alt bx-sm'></i></a>
                                            <span class="btn-flat btn-hover">
                                ...
                                <div class="img left-right col-lg-6">
                                    <div class="img-shape"></div>
                                    <img src="../root/images/banner/vans.png" alt="">
                                </div>
                            </div>
                            <!-- end slide item -->
                            <!-- slide item -->
                            <div class="slide col-lg-12">
                                <div class="info col-lg-6">
                                    <div class="info-content">
                                        ...
                                        <p class="top-down trans-delay-0-4">
                                            Converse 70s Space Racer có thiết kế hoàn toàn mới với việc tận dụng chất liệu Polyester vào thân giày trong kiểu dáng Chuck 70s cổ thấp. Điểm nhấn của sản phẩm nằm ở phần dây giày tròn, dạng rút, có độ đàn hồi tốt để bạn dễ dàng mang tháo.
                                        </p>
                                        <div class="top-down trans-delay-0-6 d-flex align-items-center">
                                            <a href="#" class="btn-icon"> <i class='bx bx-expand-alt bx-sm'></i></a>
                                            <span class="btn-flat btn-hover">
                                ...
                                <div class="img right-left col-lg-6">
                                    <div class="img-shape"></div>
                                    <img src="../root/images/banner/converse.png" alt="">
                                </div>
                            </div>
                            <!-- end slide item -->
                        </div>
...
<!-- End banner Area -->
<!-- Start category Area -->
<section class="category-area mt-5" data-aos="fade-up">
    <div class="container">
        <div class="row justify-content-center">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8" data-aos="fade-up">
                        <div class="single-deal">
                            ...
                            <img class="img-fluid w-100" src="../root/images/category/c1.jpg" alt="">
                            <a href="">
                    ...
                    <div class="col-lg-4 col-md-4" data-aos="fade-up">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="../root/images/category/c2.jpg" alt="">
                            <a href="#">
                                <div class="deal-details">
                    ...
                    <div class="col-lg-4 col-md-4" data-aos="fade-up">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="../root/images/category/c3.jpg" alt="">
                            <a href="#">
                                <div class="deal-details">
                    ...
                    <div class="col-lg-8 col-md-8" data-aos="fade-up">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="../root/images/category/c4.jpg" alt="">
                            <a href="">
                                <div class="deal-details">
            ...
            <div class="col-lg-4 col-md-6 media-small" data-aos="fade-up">
                <div class="single-deal">
                    <div class="overlay"></div>
                    <img class="img-fluid w-100" src="../root/images/category/c5.jpg" alt="">
                    <a href="#">
                        <div class="deal-details">
                            <h6 class="deal-title">Sneaker for Sports</h6>
                        </div>
        ...
        <div class="row features-inner shadow-lg">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6" data-aos="zoom-in">
                <div class="single-features">
                    <div class="f-icon">
                        <img src="../root/images/features/f-icon1.png" alt="">
                    </div>
                    <h6>Giao Hàng Miễn Phí</h6>
                    <p>Sản phẩm được vận chuyển miễn phí.</p>
                </div>
            </div>
            <!-- single features -->
            <div class="col-lg-3 col-md-6 col-sm-6" data-aos="zoom-in">
                <div class="single-features">
                    <div class="f-icon">
                        <img src="../root/images/features/f-icon2.png" alt="">
                    </div>
                    <h6>Đổi Trả Hàng</h6>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6" data-aos="zoom-in">
                <div class="single-features">
                    <div class="f-icon">
                        <img src="../root/images/features/f-icon3.png" alt="">
                    </div>
                    <h6>Hỗ trợ 24/7</h6>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6" data-aos="zoom-in">
                <div class="single-features">
                    <div class="f-icon">
                        <img src="../root/images/features/f-icon4.png" alt="">
                    </div>
...
<section class="category-area mb-5" data-aos="fade-up">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-12 media-small" data-aos="fade-up">
                <div class="single-deal">
                    <div class="overlay"></div>
                    <img class="img-fluid w-100" src="../root/images/category/d1.jpg" alt="">
                    <a href="#">
                        <div class="deal-details">
                            <h6 class="deal-title">Adidas</h6>
                        </div>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    <div class="col-lg-6 col-md-6" data-aos="fade-up">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="../root/images/category/d2.jpg" alt="">
                            <a href="">
                                <div class="deal-details">
                                    <h6 class="deal-title">Vans</h6>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6" data-aos="fade-up">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="../root/images/category/d3.jpg" alt="">
                            <a href="#">
                                <div class="deal-details">
                                    <h6 class="deal-title">Converse</h6>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6" data-aos="fade-up">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="../root/images/category/d5.jpg" alt="">
                            <a href="#">
                                <div class="deal-details">
                                    <h6 class="deal-title">Nike</h6>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6" data-aos="fade-up">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="../root/images/category/d4.jpg" alt="">
                            <a href="https://localhost:44302/home/products?brands=nike">
                                <div class="deal-details">
                                    <h6 class="deal-title">MLB</h6>
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-12 no-padding exclusive-left">
                <div class="row">
                    <div class="exclusive-deal-txt col-lg-10">
                        ...
                        <a asp-action="FlashSale" class="primary-btn">Xem ngay<i class='bx bx-send primary-btn-icon'></i></a>
                    </div>
                    <div class="exclusive-deal-img col-lg-2">
                        <img src="../root/images/exclusive.png" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Start brand Area -->
<section class="brand-area section_gap" data-aos="fade-up">
    <div class="container">
        <div class="row" data-aos="zoom-in-up">
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="../root/images/brand/1.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="../root/images/brand/2.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="../root/images/brand/3.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="../root/images/brand/4.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="../root/images/brand/5.png" alt="">
            </a>
        </div>
    </div>
</section>
